...
if($studentByNic != null) exit("<h1 style='color: aliceblue'>NIC is already exists</h1>");

$studentByEmail = Student::getByEmail($email);
if($studentByEmail != null) exit("<h1 style='color: aliceblue'>Email is already exists</h1>");
...
if ($success) header("location:detail.php?id=$student->id");
